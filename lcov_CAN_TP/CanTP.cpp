...
void (*App_Callback)(uint32_t RxPduId, PduInfoType* PduInfoPtr) = 0;
...
volatile uint8_t CANIF_FLAG = 0;
volatile uint8_t Decoded_Flag =0;
volatile uint8_t infinity_loop_flag =0;
