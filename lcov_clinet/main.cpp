...
volatile uint8_t Main_Menu_Flag = 0;
volatile uint8_t Control_Session_Menu_Flag = 0;
volatile uint8_t Read_Data_Menu_Temp_or_Func_Flag = 0;
volatile uint8_t Read_Data_Menu_Else_Flag = 0;
volatile uint8_t Security_Access_Menu_Flag = 0;
volatile uint8_t Write_Data_Menu_Press_or_Func_Flag = 0;
volatile uint8_t Write_Data_Menu_Else_Flag = 0;
volatile uint8_t Response_Permission_Menu_Flag = 0;
volatile uint8_t Target_Selection_Menu_Flag = 0;
volatile uint8_t Write_Data_Menu_Temp_or_Func_Flag = 0;
volatile uint8_t Read_Data_Menu_Press_or_Func_Flag = 0;
...
void HAL_UART_RxCpltCallback(/*UART_HandleTypeDef *huart*/ uint8_t Menu_Letter)
{
...
void Display_Menu(void)
{
	...
	case Read_Data_Menu:
		...
		{
			Read_Data_Menu_Temp_or_Func_Flag = 1;
	...
	case Response_Permission_Menu:
		Response_Permission_Menu_Flag = 1;
